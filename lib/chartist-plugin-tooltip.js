    ...
    Chartist.plugins.tooltip = function (options) {
        ...
        return function tooltip(chart) {
            ...
            $chart.on('mouseenter', tooltipSelector, function() {
                ...
                $toolTip.html(tooltipText).show().css({
                    left: offset.left - $toolTip.width() / 2 - chartOffset.left - 10,
                    top: offset.top - $toolTip.height() - chartOffset.top - 40,
                });
            });
            ...
            /* This slows down mouseenter handlinf and doesn't look great.
