/**
 * Chartist.js plugin to display a data label on top of the points
 * in a line chart.
 *
 * From https://github.com/gionkunz/chartist-plugin-pointlabels/
 */
/* global Chartist */
(function(window, document, Chartist) {
  ...
  Chartist.plugins.ctPointLabels = function(options) {
    ...
    function addLabel(position, data) {
      ...
      }, options.labelClass).text(data.series[data.index].pointLabel);
    }
    ...
    return function ctPointLabels(chart) {
      if (chart instanceof Chartist.Line || chart instanceof Chartist.Bar) {
        chart.on('draw', function(data) {
          ...
          if (positonCalculator && data.series[data.index].pointLabel) {
