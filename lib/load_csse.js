...
var raw_ts_base_url = "https://raw.githubusercontent.com/CSSEGISandData" +
  "/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/";
var raw_old_ts_base_url = "https://raw.githubusercontent.com/CSSEGISandData" +
  "/COVID-19/master/archived_data/archived_time_series/";
var raw_daily_base_url = "https://raw.githubusercontent.com/CSSEGISandData" +
  "/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports/";
var ts_base_url = "https://cdn.jsdelivr.net/gh/CSSEGISandData" +
  "/COVID-19@master/csse_covid_19_data/csse_covid_19_time_series/";
var old_ts_base_url = "https://cdn.jsdelivr.net/gh/CSSEGISandData" +
  "/COVID-19@master/archived_data/archived_time_series/";
var daily_base_url = "https://cdn.jsdelivr.net/gh/CSSEGISandData" +
  "/COVID-19@master/csse_covid_19_data/csse_covid_19_daily_reports/";
    ...
    function start_download(k) {
      ...
      Papa.parse(url, {
        ...
        complete: r => {
          ...
          pending -= 1;
          if (!pending) resolve(merge_csse_files(results));
        },
        error: () => {
          pending -= 1;
          if (!pending) resolve(merge_csse_files(results));
...
function merge_csse_files(splits) {
  var results = {};
